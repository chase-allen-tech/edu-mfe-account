...
class YourPreferencePage extends React.Component {
      ...
      <>
        <div className="tab-content" id="myTabContent">
          ...
          <div className="tab-pane fade show active" id="general-information" role="tabpanel" aria-labelledby="home-tab">
            <h2 className="heading mt-2 fsp-24 lh-38 fw-bold text-a mbp-30">Your Preferences</h2>
            <h2 className="heading mt-5 fsp-24 lh-38 fw-bold text-a mbp-30">Notification in the platform</h2>

            <div className="p-4 my-4 shadow-main bg-white">
              <div className="row mb-2">
                <div className="col-lg-10">
                  <div className="fsp-16 fw-normal lh-25">Respond to my comments</div>
                </div>
              ...
              <div className="row">
                <div className="col-lg-10">
                  <div className="fsp-16 fw-normal lh-25">New comments on my training</div>
                </div>
                <div className="col-lg-2">
                  <div className="form-check form-switch">
            ...
            <h2 className="heading mt-5 fsp-24 lh-38 fw-bold text-a mbp-30">Email Notification</h2>
            <div className="fsp-16 fw-normal lh-25">Check the types of emails you want to receive</div>

            <div className="p-4 my-4 shadow-main bg-white">
              <div className="row mb-2">
                <div className="col-lg-10">
                  <div className="fsp-16 fw-normal lh-25">Announcements related to training courses I have registered for</div>
                </div>
                <div className="col-lg-2">
                  <div className="form-check form-switch">
              ...
              <div className="row mb-2">
                <div className="col-lg-10">
                  <div className="fsp-16 fw-normal lh-25">Reminders related to training courses I have registered for</div>
                </div>
                <div className="col-lg-2">
                  <div className="form-check form-switch">
              ...
              <div className="row">
                <div className="col-lg-10">
                  <div className="fsp-16 fw-normal lh-25">Email Responses</div>
                </div>
                <div className="col-lg-2">
                  <div className="form-check form-switch">
            ...
            <div className="fsp-16 fw-normal lh-25">A quick phone call to help resume your training if you're running late?</div>
            ...
            <h2 className="heading mt-5 fsp-24 lh-38 fw-bold text-a mbp-30">Language</h2>
            <div className="fsp-16 fw-normal lh-25">Select the language you want to use in the platform:</div>

            <div className="p-4 my-4 shadow-main bg-white">
              <div className="row">
                <div className="col-lg-10">
                  <div className="fsp-11 fw-500 lh-26 pb-3 text-uppercase">Language</div>
                  <div className="d-flex" onChange={this.onChangeLanguage}>
                    <div className="form-check">
                      <input className="form-check-input" type="radio" name="flexRadioDefault" value="en" id="flexSwitchCheckChecked1" defaultChecked />
                      <label className="form-check-label" for="flexSwitchCheckChecked1">English</label>
                    </div>
                    <div className="form-check ml-3">
                      <input className="form-check-input" type="radio" name="flexRadioDefault" value="fr" id="flexSwitchCheckChecked2" />
                      <label className="form-check-label" for="flexSwitchCheckChecked2">French</label>
                    </div>
                  </div>
                </div>
              </div>
...
YourPreferencePage.contextType = AppContext;

YourPreferencePage.propTypes = {
...
YourPreferencePage.defaultProps = {
  loading: false,
  loaded: false,
  loadingError: null,
  saveState: null,
