...
import AccountSettingsPage, { NotFoundPage, YourAccountPage, YourPreferencePage, YourDocumentPage } from './account-settings';
        ...
        <div className="d-flex flex-column" style={{ minHeight: '100vh' }}>
          ...
          <main className="flex-grow-1">
            <Switch>
              ...
              <Route path="/setting" component={AccountSettingsPage} />
